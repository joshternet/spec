...
Open specifications for Josh identity, discovery, and inter-Josh networking.

> **Specification status:** PRE-JOSH

This repository is the canonical home for the open standards that define the Joshternet.

The Joshternet is a decentralized network for connecting people who identify as Josh and the websites they call home. These specifications define how a Josh declares participation, how Josh nodes are discovered, and how participants navigate and communicate across the network.
...
* A Josh retains control of their own identity and website.
